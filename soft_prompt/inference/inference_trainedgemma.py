...
parser.add_argument(
    "--model_path", type=str, default="/ext0/hcchai/codemate/gemma/gemma-7b-it"
)
...
parser.add_argument(
    ...
    "--trained_model_path",
    type=str,
    default="/home/jzchen/ML/AfterCodegrag/trained_models/appsnew/python/Gemma/checkpoint-33",
)
...
def generate_and_tokenize_prompt(task):
    ...
    user_prompt = f"<bos><start_of_turn>user\nPlease use {LANG} to write a correct solution to a programming problem. You should give executable completed code and nothing else. The problem:\n{task}<end_of_turn>\n<start_of_turn>model\n"
    output_prompt = ""
