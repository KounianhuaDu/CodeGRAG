...
def generate_and_tokenize_prompt(task):
    ...
    user_prompt = f"Question: Please use {LANG} to write a correct solution to a programming problem. You should give executable completed code and nothing else. The problem:\n{task}\n\nAnswer:"
    output_prompt = ""
