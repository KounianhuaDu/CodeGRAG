...
class CodeLlama4Code(nn.Module):
    def __init__(
        self,
        input_dim,
        output_dim,
        ...
        super(CodeLlama4Code, self).__init__()
        ...
        self.llama_tokenizer = LlamaTokenizerFast.from_pretrained(
    ...
    def forward(self, *args, **kwargs):
        ...
        x_emb = torch.zeros([bs, seq_lenth, 4096], dtype=torch.bfloat16).to(
