...
parser.add_argument(
    "--model_path",
    type=str,
    default="/ext0/hcchai/codemate/gemma/gemma-7b",
)
...
def generate_and_tokenize_prompt(data_point):
    ...
    user_prompt = f"<bos><start_of_turn>user\nPlease use {LANG} to write a correct solution to a programming problem. We also have the syntax graph embedding of a similary problem encoded in <GraphEmb> for you to refer to. You should give executable completed code and nothing else. The problem:\n{task}<end_of_turn>\n"
