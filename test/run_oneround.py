...
def main(k, data_path, output_path, value):
    ...
    while(True):
        check_point_path = os.path.join(output_path, f'checkpoint_one_round_with_{value}_{k}.npy')
        ...
        try:
            ...
            write_jsonl(os.path.join(output_path, f"samples_one_round_with_{value}_{k}.jsonl"), samples)
