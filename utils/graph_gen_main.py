...
parser.add_argument('--writepath', type=str, default='./temp/')
parser.add_argument('--astpath', type=str, default='../data/Cgraphs/ast/')
parser.add_argument('--cfgpath', type=str, default='../data/Cgraphs/cfg/')
parser.add_argument('--picky', type=str, default=0, help = '取文件名作为label（WebCode）：1，取文件夹的名字作为label（POJ， SOJ）：0')
